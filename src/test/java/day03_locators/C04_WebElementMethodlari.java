 ...
 */
    public static void main(String[] args) {
        ...
        String actualTanName=aramaKutusu.getTagName();
        if (expectedTagName.equals(actualTanName)){
            System.out.println("TagName testi PASSED");
        }else {
            System.out.println("TagName testi FAILET");
        }
        ...
        if (expectedNameDegeri.equals(actualNameDegeri)){
            ...
            System.out.println("name attribute testi FAILET");
        }
