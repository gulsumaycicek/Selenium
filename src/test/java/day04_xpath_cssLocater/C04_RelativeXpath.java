...
public class C04_RelativeXpath {
    public static void main(String[] args) {
        ...
        WebElement mountie=driver.findElement(RelativeLocator.with(By.tagName("img")).above(bostonWE).toLeftOf(sailorWE));

        System.out.println(mountie.getAttribute("id"));//pid2_thumb
